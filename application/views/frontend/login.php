			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<form action="<?php echo site_url('authhr/login') ?>" method="post">
							<div class="form-group mb-lg">
								<label>ID</label>
								<div class="input-group input-group-icon">
									<input name="id_user" type="text" class="form-control input-lg" autocomplete="off" autofocus />
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="sandi_user" type="password" class="form-control input-lg" />
									<span class="input-group-addon">
										<span class="icon icon-lg">
				...
				<p class="text-center text-muted mt-md mb-md">&copy; Copyright 2021. All rights reserved. PT Cosmoprof Indokarya Pemalang.</p>
			</div>
		</section>
		<!-- end: page -->
