...
<!--Form-->
<form method="post" action="<?php echo site_url('performausr/update/'.$edit['id_performa']) ?>">

  <label>Tanggal</label>
  <input name="tgl" id="tanggal" class="form-control datepicker" type="text" value="<?php echo $edit['tgl'] ?>" autocomplete="off">

  <label>NIP</label><br>
  <input type="text" name="nip" class="form-control" placeholder="Masukan NIP Operator" value="<?php echo $edit['nip'] ?>" required oninvalid="this.setCustomValidity('NIP Harus Di Isi')" oninput="setCustomValidity('')" autocomplete="off"><p></p>
  ...
  <input type="text" name="target" class="form-control" placeholder="Masukan Target" value="<?php echo $edit['target'] ?>" required oninvalid="this.setCustomValidity('NIK KTP Harus Di Isi')" oninput="setCustomValidity('')" autocomplete="off"><p></p>
