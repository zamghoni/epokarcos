        ...
        <div class="about-info">
          <h2 class="mb-4" data-aos="fade-up"> <strong>Statistik Evaluasi Produktivitas Karyawan
            ...
            <?php  $attributes = array('onsubmit' => 'return tambah(this)');
              echo form_open_multipart('dashprod/process',$attributes);?>
          ...
          <div class="row">
               ...
               <div class="col-lg-7 mx-auto col-md-10 col-12">
                    <div class="about-info">
                         ...
                         <h2 class="mb-4" data-aos="fade-up"> <strong>Sistem Informasi Evaluasi Produktivitas Karyawan</strong> (EPOKAR)</h2>

                         <p class="mb-0" data-aos="fade-up">Merupakan sebuah sistem informasi yang ditujukan untuk efisiensi manajemen data evaluasi operator.
