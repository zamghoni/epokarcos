...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <?php if ($this->uri->segment(1)!= 'performamid' && $this->uri->segment(2) != 'create'){ ?>
  ...
  <link href="<?=base_url('assets/backend/')?>vendor/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
  <?php } ?>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="<?php echo site_url('dashprod'); ?>" class="logo"><b>EP<span>OKAR</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a href="<?php echo site_url('authprod/logout'); ?>" title="logout"> <button type="button" class="btn btn-danger" >Logout</button> </a>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="<?php echo site_url('dashprod'); ?>"><img src="<?php echo base_url(); ?>assets/frontend/img/cosmo.png" class="img-circle" width="80"></a></p>
          <h5 class="centered">INDOKARYA</h5>

          <li class="nav-item">
            <a href="<?php echo site_url('dashprod') ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('performamid') ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('authprod/logout') ?>">
...
<?php } else { ?>
  <script src="<?=base_url('assets/backend/')?>vendor/select2/js/select2.min.js"></script>
