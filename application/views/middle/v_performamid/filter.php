...
<a href="<?php echo site_url('performausr/create'); ?>" title="Tambah"> <button type="button" class="mb-xs mt-xs mr-xs btn btn-primary">Tambah <i class="fa fa-plus"></i></button></a>
