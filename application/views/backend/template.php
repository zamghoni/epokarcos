...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="<?php echo base_url(); ?>assets/frontend/index.html" class="logo"><b>EP<span>OKAR</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a href="<?php echo site_url('auth/logout'); ?>" title="logout"> <button type="button" class="btn btn-danger" >Logout</button> </a>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="<?php echo base_url(); ?>assets/frontend/profile.html"><img src="<?php echo base_url(); ?>assets/frontend/img/cosmo.png" class="img-circle" width="80"></a></p>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('bagian') ?>">
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
          ...
          -->
          Created with Dashio template by <a href="<?php echo base_url(); ?>assets/frontend/https://templatemag.com/">TemplateMag</a>
        </div>
        <a href="<?php echo base_url(); ?>assets/frontend/blank.html#" class="go-top">
